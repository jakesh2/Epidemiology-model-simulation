...
# Updated recommend_model function with bounds on parameters
def recommend_model(data):
    ...
    # Add bounds to prevent unrealistic values for beta and gamma
    sir_popt, _ = curve_fit(sir_equations, days, infected_data, p0=[0.3, 0.1], bounds=([0, 0], [1, 1]))
    ...
    # Add bounds for SEIR model parameters
    seir_popt, _ = curve_fit(seir_equations, days, infected_data, p0=[0.3, 0.1, 0.2], bounds=([0, 0, 0], [1, 1, 1]))
    ...
    # Add bounds for SIS model parameters
    sis_popt, _ = curve_fit(sis_equations, days, infected_data, p0=[0.3, 0.1], bounds=([0, 0], [1, 1]))
...
# Run the function with bounds on parameters
